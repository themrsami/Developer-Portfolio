...
const Contact = () => {
  ...
  <div className="hidden lg:block absolute top-0 right-0 h-full bg-gray-600 w-1/2"></div>
      ...
      <div className="flex flex-wrap -mx-4">
            ...
            <div className="pb-16 mb-8 border-b border-gray-400">
              ...
              <div className="py-6 px-8 mb-4 bg-gray-600 rounded-lg">
                <div className="flex items-center">
                  ...
                  <p className="text-lg font-bold text-white">Bayswater, London</p>
                </div>
              </div>
            </div>
            <div className="max-w-xs">
              <p className="text-gray-400">The one est bad, semper six at sem quis, congue 8 AM - 8 PM</p>
            </div>
          </div>
        </div>
        <div className="relative w-full lg:w-1/2 px-4 pb-20">
          <div className="max-w-md lg:ml-20">
            <form action="#">
              <h3 className="mb-10 text-2xl font-bold text-white">Send a message!</h3>
              <input className="mb-3 w-full px-12 py-4 bg-white font-bold placeholder-gray-900 rounded-full focus:outline-none" type="email" placeholder="example@shuffle.dev"/>
              <input className="mb-3 w-full px-12 py-4 bg-white font-bold placeholder-gray-900 rounded-full focus:outline-none" type="text" placeholder="Subject"/>
              <textarea className="w-full mb-6 px-12 py-4 bg-white font-bold placeholder-gray-900 rounded-3xl resize-none focus:outline-none" name="" id="" cols={30} rows={10} placeholder="Your message"></textarea>
              <div className="flex mb-10">
                <input type="checkbox"/>
                <p className="pl-4 max-w-xs text-sm text-gray-300">By singning up, you agree to our Terms, Data Policy and Cookies.</p>
              </div>
              <button className="py-4 px-12 text-white font-bold bg-blue-500 hover:bg-blue-600 rounded-full transition duration-200">Send message</button>
            </form>
          </div>
        </div>
      </div>
