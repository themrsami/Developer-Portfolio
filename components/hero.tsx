...
const Hero = () => {
  ...
  return (
    <div className='flex flex-col justify-center items-center mx-auto h-screen'>
      <SparklesText text="Usama Nazir" colors={colors} />
      ...
      <BorderBeam>
        <WordRotate
          className={`text-md sm:text-xl md:text-2xl text-center font-bold ${rotatetext} m-2 py-1 px-6 w-60 sm:w-80`}
